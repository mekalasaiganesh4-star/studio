        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-4 text-lg">
              Join our mission to reduce food waste. Turn your surplus food into revenue and help the community.
            </p>
            <ul className="mt-6 space-y-4">
              <li className="flex items-start">
                <ChefHat className="w-6 h-6 text-primary mr-3 mt-1 shrink-0" />
                <span><strong>Sell Surplus:</strong> Easily list your unsold, fresh food items.</span>
              </li>
              <li className="flex items-start">
                <UtensilsCrossed className="w-6 h-6 text-primary mr-3 mt-1 shrink-0" />
                <span><strong>Reduce Waste:</strong> Contribute to a sustainable future and enhance your brand image.</span>
              </li>
              <li className="flex items-start">
                <Heart className="w-6 h-6 text-primary mr-3 mt-1 shrink-0" />
                <span><strong>Support Community:</strong> Provide affordable meals to people in your area.</span>
              </li>
            </ul>
...
function AnimalFeedSection() {
  const animalImage = PlaceHolderImages.find((img) => img.id === 'farm-animals');
  return (
    <section className="py-16 md:py-24 bg-secondary/50">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:order-1">
            ...
            <p className="text-muted-foreground mt-4 text-lg">
              Food that's no longer for humans can still make a difference. We redirect surplus to animal feed.
            </p>
            <ul className="mt-6 space-y-4">
              <li className="flex items-start">
                <Beef className="w-6 h-6 text-primary mr-3 mt-1 shrink-0" />
                <span><strong>For Farmers & NGOs:</strong> Access low-cost or free food for animal consumption.</span>
              </li>
              <li className="flex items-start">
                <Heart className="w-6 h-6 text-primary mr-3 mt-1 shrink-0" />
                <span><strong>Complete the Cycle:</strong> Ensure nothing goes to waste, supporting local agriculture and animal welfare.</span>
              </li>
            </ul>
    ...
    return (
        <section className="py-16 md:py-24 bg-primary text-primary-foreground">
            <div className="container mx-auto px-4 text-center">
                ...
                <h2 className="text-3xl md:text-4xl font-bold font-headline">Personalized For You</h2>
                <p className="mt-4 max-w-2xl mx-auto text-lg">
                    Our AI-powered suggestion tool helps you discover new meals based on your tastes and past orders. Never miss out on a great deal!
                </p>
